...
This model is part of the Genetic Algorithms series of the Complexity Explorer project.  
Main Author:  Melanie Mitchell

Contributions from:  Seth Tisue, Uri Wilensky
...
If you use this model, please cite it as: "Robby the Robot Genetic Algorithms" model, Complexity Explorer project, http://complexityexplorer.org
